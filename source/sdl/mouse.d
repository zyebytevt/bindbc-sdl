...
mixin(makeEnumBind(q{SDL_MouseButtonFlags}, q{SDL_MouseButtonFlags_}, aliases: [q{SDL_ButtonMask}], members: (){
	EnumMember[] ret = [
...
pragma(inline,true) extern(C) SDL_MouseButtonFlags SDL_BUTTON_MASK(SDL_MouseButton x) nothrow @nogc pure @safe =>
